          ...
          <div className="container">
            ...
            <div className="box m-t-50">
              ...
              <div className="content">
                <h1 className="has-text-black">Black</h1>
                <h1 className="has-text-black-bis">Black-bis</h1>
                <h1 className="has-text-black-ter">Black-ter</h1>
                <h1 className="has-text-grey-darker">Grey-darker</h1>
                <h1 className="has-text-grey-dark">Grey-dark</h1>
                <h1 className="has-text-grey">Grey</h1>
                <h1 className="has-text-grey-light">Grey-light</h1>
                <h1 className="has-text-grey-lighter">Grey-lighter</h1>
